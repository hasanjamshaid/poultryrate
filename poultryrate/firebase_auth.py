...
def initialize_sdk_with_service_account():
    ...
    cred = credentials.Certificate('poultryrate-311919-firebase-adminsdk-rbvsh-828d6dabc0.json')
...
def initialize_sdk_with_refresh_token():
    ...
    cred = credentials.RefreshToken('poultryrate-311919-firebase-adminsdk-rbvsh-828d6dabc0.json')
    default_app = firebase_admin.initialize_app(cred)
...
def access_services_nondefault():
    cred = credentials.Certificate('poultryrate-311919-firebase-adminsdk-rbvsh-828d6dabc0.json')
    other_cred = credentials.Certificate('poultryrate-311919-firebase-adminsdk-rbvsh-828d6dabc0.json')
